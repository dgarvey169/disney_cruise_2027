...
- **Bug Fix Workflow via Pull Requests**:
  ...
  4. Move the Project **Status** field to **`In review`** for user testing, providing the PR link and live game link.
  5. Only close the bug and merge the PR into `main` after user testing and explicit approval.
